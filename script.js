        ...
        if (transcript.toLowerCase().includes('comandos')) {
            ...
            switch (true) {
                ...
                case transcript.toLowerCase().includes('consultar clima'):
                    ...
                    var ciudad = prompt("Por favor, ingresa la canción que quieres escuchar:");
                    if (ciudad) {
                        var urlGoogleClima = 'https://www.youtube.com/results?search_query=' + ciudad;
                        window.open(urlGoogleClima, '_blank');
                    } else {
                        alert("Debes ingresar una canción para buscarla.");
                    }
                    break;
                default:
